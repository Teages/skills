...
- `Mesh`.[`ViewContainer`](scene.ViewContainer.md)\<`MeshGpuData`\>
...
> **new Mesh**\<`GEOMETRY`, `SHADER`\>(`options`): `Mesh`\<`GEOMETRY`, `SHADER`\>

#### Parameters

##### options

[`MeshOptions`](scene.MeshOptions.md)\<`GEOMETRY`, `SHADER`\>
...
> **new Mesh**\<`GEOMETRY`, `SHADER`\>(`geometry`, `shader`, `state?`, `drawMode?`): `Mesh`\<`GEOMETRY`, `SHADER`\>
...
Alias for [Mesh#shader](#shader-1).
