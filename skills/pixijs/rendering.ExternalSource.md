...
- [`TextureSource`](rendering.TextureSource.md)\<[`GPUTexture`](https://developer.mozilla.org/docs/Web/API/GPUTexture) \| [`WebGLTexture`](https://developer.mozilla.org/docs/Web/API/WebGLTexture)\>

## Constructors

### Constructor

> **new ExternalSource**(`__namedParameters`): `ExternalSource`
...
> **resource**: [`GPUTexture`](https://developer.mozilla.org/docs/Web/API/GPUTexture) \| [`WebGLTexture`](https://developer.mozilla.org/docs/Web/API/WebGLTexture)
...
> **updateGPUTexture**(`gpuTexture`, `width?`, `height?`): `void`
...
[`GPUTexture`](https://developer.mozilla.org/docs/Web/API/GPUTexture) | [`WebGLTexture`](https://developer.mozilla.org/docs/Web/API/WebGLTexture)

##### width?

`number`

New width (required for WebGLTexture, auto-detected for GPUTexture)
...
> `static` **test**(`resource`): resource is GPUTexture \| WebGLTexture
...
True if the resource is a GPUTexture or WebGLTexture
