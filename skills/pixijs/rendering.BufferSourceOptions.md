...
- [`TextureSourceOptions`](rendering.TextureSourceOptions.md)\<[`TypedArray`](rendering.TypedArray.md) \| [`ArrayBuffer`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer)\>
...
> `optional` **resource**: [`ArrayBuffer`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) \| [`TypedArray`](rendering.TypedArray.md)
