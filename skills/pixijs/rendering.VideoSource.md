...
- [`TextureSource`](rendering.TextureSource.md)\<[`VideoResource`](rendering.VideoResource.md)\>
...
> `static` **defaultOptions**: [`VideoSourceOptions`](rendering.VideoSourceOptions.md)
...
> `readonly` `static` **MIME\_TYPES**: [`Dict`](utils.Dict.md)\<`string`\>
