...
- [`TextureSource`](rendering.TextureSource.md)\<[`TypedArray`](rendering.TypedArray.md) \| [`ArrayBuffer`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer)\>
...
> **resource**: [`ArrayBuffer`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) \| [`TypedArray`](rendering.TypedArray.md)
...
> `static` **extension**: [`ExtensionMetadata`](extensions.ExtensionMetadata.md) = `ExtensionType.TextureSource`
