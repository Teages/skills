...
- [`RenderTargetSystem`](rendering.RenderTargetSystem.md)\<`GpuRenderTarget`\>

## Constructors

### Constructor

> **new GpuRenderTargetSystem**(`renderer`): `GpuRenderTargetSystem`
...
> **getGpuRenderTarget**(`renderTarget`): `GpuRenderTarget`
