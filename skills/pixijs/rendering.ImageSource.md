...
- [`TextureSource`](rendering.TextureSource.md)\<[`ImageResource`](rendering.ImageResource.md)\>

## Constructors

### Constructor

> **new ImageSource**(`options`): `ImageSource`

#### Parameters

##### options

[`TextureSourceOptions`](rendering.TextureSourceOptions.md)\<[`ImageResource`](rendering.ImageResource.md)\>
...
> **resource**: [`ImageResource`](rendering.ImageResource.md)
...
> `static` **test**(`resource`): `resource is ImageResource`
