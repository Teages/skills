...
PixiJS uses a hierarchical [scene graph](core-concepts-1.md) to represent all visual objects. Before rendering, the engine traverses the tree to:
...
- Skip off-screen objects if [culling](core-concepts-1.md) is enabled
