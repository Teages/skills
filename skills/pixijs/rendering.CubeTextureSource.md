# Class: CubeTextureSource

**`Advanced`**

A [TextureSource](rendering.TextureSource.md) that represents a cube texture (6 faces).
...
Create a cube source from 6 already-created [TextureSource](rendering.TextureSource.md) instances:
...
- [`TextureSource`](rendering.TextureSource.md)\<[`CubeTextureFaces`](rendering.CubeTextureFaces.md)\<[`TextureSource`](rendering.TextureSource.md)\>\>

## Constructors

### Constructor

> **new CubeTextureSource**(`options`): `CubeTextureSource`
...
> `readonly` **faces**: [`CubeTextureFaces`](rendering.CubeTextureFaces.md)\<[`TextureSource`](rendering.TextureSource.md)\<`any`\>\>
...
> **resource**: [`CubeTextureFaces`](rendering.CubeTextureFaces.md)
