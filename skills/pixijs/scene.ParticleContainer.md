...
- `ParticleContainer`.[`ViewContainer`](scene.ViewContainer.md)\<`ParticleBuffer`\>
...
> **new ParticleContainer**\<`T`\>(`options`): `ParticleContainer`\<`T`\>

#### Parameters

##### options

[`ParticleContainerOptions`](scene.ParticleContainerOptions.md)\<`T`\> = `{}`
...
#### See
 ...
 - [ParticleContainer#update](#update) For updating after modifications
 - [ParticleContainer#addParticle](#addparticle) For a safer way to add particles
 - [ParticleContainer#removeParticle](#removeparticle) For a safer way to remove particles
...
> **shader**: [`Shader`](rendering.Shader.md)
...
#### See
 ...
 - [ParticleContainerOptions#texture](scene.ParticleContainerOptions.html#texture) For setting texture via constructor
 - [Particle](scene.Particle.md) For creating particles with textures
...
> `static` **defaultOptions**: [`Pick`](https://www.typescriptlang.org/docs/handbook/utility-types.html#picktype-keys)\<[`ParticleContainerOptions`](scene.ParticleContainerOptions.md), `"dynamicProperties"` \| `"roundPixels"`\>
...
##### See
 ...
 - [Container#boundsArea](scene.Container.html#boundsarea) For manually setting container bounds
...
An empty bounds object (0,0,0,0)
...
The Particle(s) to add to the container

#### Returns

`T`

The first particle that was added, for method chaining
...
#### See
 ...
 - [ParticleContainer#texture](#texture) For setting the shared texture
 - [ParticleContainer#update](#update) For updating after modifications
...
`U` *extends* [`IParticle`](scene.IParticle.md) = `T`
...
The absolute index where the particle will be positioned at the end of the operation.

#### Returns

`U`

The particle that was added.
...
The Particle(s) to remove from the container

#### Returns

`T`

The first particle that was removed, for method chaining
...
#### See
 ...
 - [ParticleContainer#particleChildren](#particlechildren) For accessing all particles
 - [ParticleContainer#removeParticles](#removeparticles) For removing particles by index
 - [ParticleContainer#removeParticleAt](#removeparticleat) For removing a particle at a specific index

***

### removeParticleAt()

> **removeParticleAt**\<`U`\>(`index`): `U`
...
The index to get the particle from

#### Returns

`U`

The particle that was removed.

***

### removeParticles()

> **removeParticles**(`beginIndex?`, `endIndex?`): `T`[]
...
#### See
 ...
 - [ParticleProperties](scene.ParticleProperties.md) For configuring dynamic vs static properties
 - [ParticleContainer#particleChildren](#particlechildren) For direct array access
