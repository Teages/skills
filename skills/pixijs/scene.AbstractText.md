# Abstract Class: AbstractText\<TEXT_STYLE, TEXT_STYLE_OPTIONS, TEXT_OPTIONS, GPU_DATA\>
...
- [`ViewContainer`](scene.ViewContainer.md)\<`GPU_DATA`\>
...
`TEXT_OPTIONS` *extends* [`TextOptions`](text.TextOptions.md)\<`TEXT_STYLE`, `TEXT_STYLE_OPTIONS`\> = [`TextOptions`](text.TextOptions.md)\<`TEXT_STYLE`, `TEXT_STYLE_OPTIONS`\>

### GPU_DATA

`GPU_DATA` *extends* `object` = `any`
...
> **new AbstractText**\<`TEXT_STYLE`, `TEXT_STYLE_OPTIONS`, `TEXT_OPTIONS`, `GPU_DATA`\>(`options`, `styleClass`): `AbstractText`\<`TEXT_STYLE`, `TEXT_STYLE_OPTIONS`, `TEXT_OPTIONS`, `GPU_DATA`\>
...
`AbstractText`\<`TEXT_STYLE`, `TEXT_STYLE_OPTIONS`, `TEXT_OPTIONS`, `GPU_DATA`\>
...
[`View`](scene.View.md).[`containsPoint`](scene.View.html#containspoint)
