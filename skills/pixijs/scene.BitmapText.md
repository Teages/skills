...
## See
 ...
 - [BitmapFont](text.BitmapFont.md) For font installation and management
 - [Text](https://developer.mozilla.org/docs/Web/API/Text) For canvas-based text rendering
 - [HTMLText](scene.HTMLText.md) For HTML/CSS-based text rendering

## Extends

- `BitmapText`.[`AbstractText`](scene.AbstractText.md)\<[`TextStyle`](text.TextStyle.md), [`TextStyleOptions`](text.TextStyleOptions.md), [`TextOptions`](text.TextOptions.md), `BitmapTextGraphics`\>
...
> **new BitmapText**(`options?`): `BitmapText`
...
The options of the bitmap text.
...
> **new BitmapText**(`text?`, `options?`): `BitmapText`
...
[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`TextStyle`](text.TextStyle.md)\>
...
`PixiMixins.BitmapText.constructor`
...
[BitmapFont.install](text.BitmapFont.html#install) For setting font resolution

##### Throws

When attempting to change resolution directly
