# Class: CanvasRenderTargetSystem
...
> **new CanvasRenderTargetSystem**(`renderer`): `CanvasRenderTargetSystem`
...
> **adaptor**: [`CanvasRenderTargetAdaptor`](rendering.CanvasRenderTargetAdaptor.md)
...
> **getGpuRenderTarget**(`renderTarget`): `CanvasRenderTarget`
