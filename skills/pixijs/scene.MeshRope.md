...
[RopeGeometry#update](scene.RopeGeometry.html#update) For manual geometry updates
...
> `static` **defaultOptions**: [`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`MeshRopeOptions`](scene.MeshRopeOptions.md)\>
...
[MeshRopeOptions](scene.MeshRopeOptions.md) For all available options
