...
The [Assets](assets.Assets.md) singleton is how you load images, spritesheets, fonts, and other resources in PixiJS. It's Promise-based, caches results automatically, and picks the best file format for the user's device. Most PixiJS projects use `Assets.load()` as their first step after creating an `Application`.
...
| ------------------- | ---------------------------------------------------------------- | --------------------------------------------------------------------- |
| Textures            | `.png`, `.jpg`, `.jpeg`, `.gif`, `.webp`, `.avif`, `.svg`        | [loadTextures](assets.loadTextures.md), [loadSvg](assets.loadSvg.md)                                 |
...
| Bitmap Fonts        | `.fnt`, `.xml`                                                   | [loadBitmapFont](assets.loadBitmapFont.md)                                                |
...
You can add custom parsers for additional formats via [LoaderParser](assets.LoaderParser.md).
...
All Asset APIs support aliases, including `Assets.load()`, `Assets.get()`, and `Assets.unload()`. For more complex resolution rules, see the [Resolver](assets-1.md) guide.
...
For manifest-based bundles, see the [Manifests & Bundles](assets-2.md) guide.
...
See the [Background Loading](assets-3.md) guide for details.
