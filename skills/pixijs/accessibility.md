...
> [!IMPORTANT] The [AccessibilitySystem](accessibility.AccessibilitySystem.md) is not available in a Web Worker. It requires the main thread where the DOM is accessible.
...
PixiJS automatically installs the [AccessibilitySystem](accessibility.AccessibilitySystem.md) onto your renderer.
