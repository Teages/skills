...
- [`AbstractSplitText`](text.AbstractSplitText.md)\<[`BitmapText`](scene.BitmapText.md)\>

## Constructors

### Constructor

> **new SplitBitmapText**(`config`): `SplitBitmapText`
...
> **chars**: [`BitmapText`](scene.BitmapText.md)[]
...
> `static` **defaultOptions**: [`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`SplitBitmapTextOptions`](text.SplitBitmapTextOptions.md)\>
...
> `static` **from**(`text`, `options?`): `SplitBitmapText`
...
[`Omit`](https://www.typescriptlang.org/docs/handbook/utility-types.html#omittype-keys)\<[`SplitBitmapTextOptions`](text.SplitBitmapTextOptions.md), `"text"` \| `"style"`\>
