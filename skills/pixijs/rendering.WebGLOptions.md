...
- [`SharedRendererOptions`](rendering.SharedRendererOptions.md).`WebGLOptions`
...
`ExtractRendererOptions.context`
...
`ExtractRendererOptions.multiView`
...
`ExtractRendererOptions.preferWebGLVersion`
...
`ExtractRendererOptions.premultipliedAlpha`
...
`ExtractRendererOptions.preserveDrawingBuffer`
...
`ExtractRendererOptions.useBackBuffer`
