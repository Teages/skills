...
- [`Mesh`](scene.Mesh.md)\<[`PerspectivePlaneGeometry`](scene.PerspectivePlaneGeometry.md)\>

## Constructors

### Constructor

> **new PerspectiveMesh**(`options`): `PerspectiveMesh`
...
> `static` **defaultOptions**: [`PerspectivePlaneOptions`](scene.PerspectivePlaneOptions.md)
...
#### See
 ...
 - [PerspectivePlaneOptions](scene.PerspectivePlaneOptions.md) For all available options
 - [PerspectivePlaneGeometry](scene.PerspectivePlaneGeometry.md) For how vertices affect perspective quality
...
##### See
 ...
 - [PerspectiveMesh#setCorners](#setcorners) For adjusting the mesh perspective
...
The PerspectiveMesh instance for method chaining
...
[PerspectivePlaneGeometry](scene.PerspectivePlaneGeometry.md) For the underlying geometry calculations
