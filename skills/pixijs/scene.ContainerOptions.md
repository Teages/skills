...
`C` *extends* [`ContainerChild`](scene.ContainerChild.md) = [`ContainerChild`](scene.ContainerChild.md)
...
`PixiMixins.ContainerOptions.cacheAsTexture`

***

### children?

> `readonly` `optional` **children**: `C`[]
...
`PixiMixins.ContainerOptions.cursor`
...
`PixiMixins.ContainerOptions.eventMode`
...
`PixiMixins.ContainerOptions.filters`
...
`PixiMixins.ContainerOptions.height`
...
`PixiMixins.ContainerOptions.hitArea`
...
`PixiMixins.ContainerOptions.interactive`
...
`PixiMixins.ContainerOptions.interactiveChildren`
...
`PixiMixins.ContainerOptions.label`
...
`PixiMixins.ContainerOptions.mask`
...
`PixiMixins.ContainerOptions.onclick`
...
`PixiMixins.ContainerOptions.onglobalmousemove`
...
`PixiMixins.ContainerOptions.onglobalpointermove`
...
`PixiMixins.ContainerOptions.onglobaltouchmove`
...
`PixiMixins.ContainerOptions.onmousedown`
...
`PixiMixins.ContainerOptions.onmouseenter`
...
`PixiMixins.ContainerOptions.onmouseleave`
...
`PixiMixins.ContainerOptions.onmousemove`
...
`PixiMixins.ContainerOptions.onmouseout`
...
`PixiMixins.ContainerOptions.onmouseover`
...
`PixiMixins.ContainerOptions.onmouseup`
...
`PixiMixins.ContainerOptions.onmouseupoutside`
...
`PixiMixins.ContainerOptions.onpointercancel`
...
`PixiMixins.ContainerOptions.onpointerdown`
...
`PixiMixins.ContainerOptions.onpointerenter`
...
`PixiMixins.ContainerOptions.onpointerleave`
...
`PixiMixins.ContainerOptions.onpointermove`
...
`PixiMixins.ContainerOptions.onpointerout`
...
`PixiMixins.ContainerOptions.onpointerover`
...
`PixiMixins.ContainerOptions.onpointertap`
...
`PixiMixins.ContainerOptions.onpointerup`
...
`PixiMixins.ContainerOptions.onpointerupoutside`
...
`PixiMixins.ContainerOptions.onRender`
...
`PixiMixins.ContainerOptions.onrightclick`
...
`PixiMixins.ContainerOptions.onrightdown`
...
`PixiMixins.ContainerOptions.onrightup`
...
`PixiMixins.ContainerOptions.onrightupoutside`
...
`PixiMixins.ContainerOptions.ontap`
...
`PixiMixins.ContainerOptions.ontouchcancel`
...
`PixiMixins.ContainerOptions.ontouchend`
...
`PixiMixins.ContainerOptions.ontouchendoutside`
...
`PixiMixins.ContainerOptions.ontouchmove`
...
`PixiMixins.ContainerOptions.ontouchstart`
...
`PixiMixins.ContainerOptions.onwheel`
...
`PixiMixins.ContainerOptions.setMask`
...
`PixiMixins.ContainerOptions.sortableChildren`
...
`PixiMixins.ContainerOptions.width`
...
`PixiMixins.ContainerOptions.zIndex`
