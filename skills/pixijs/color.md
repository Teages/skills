...
PixiJS supports a wide range of color formats through the [ColorSource](color.ColorSource.md) type:
...
- [Color](color.Color.md) for the full API
- [ColorSource](color.ColorSource.md) for all supported color formats
