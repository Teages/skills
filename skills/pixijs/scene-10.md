...
The tradeoff: every time you change the text string or style, PixiJS must re-rasterize and re-upload. This makes `Text` a poor choice for content that changes every frame (use [BitmapText](scene-11.md) instead).
...
See the guide on [TextStyle](scene-13.md) for more details.
