...
- [`ViewContainer`](scene.ViewContainer.md)\<`never`\>

## Constructors

### Constructor

> **new DOMContainer**(`options`): `DOMContainer`
...
The options for creating the DOM container.
...
> **get** **anchor**(): [`Point`](maths.Point.md)
