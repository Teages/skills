...
- Text splitting options from [SplitBitmapOptions](text.SplitBitmapOptions.md)
- Additional PixiJS-specific options from PixiMixins.SplitBitmapText

## See

 - [SplitBitmapText](text.SplitBitmapText.md) For the main implementation
 - [ContainerOptions](scene.ContainerOptions.md) For base container properties
 - [SplitBitmapOptions](text.SplitBitmapOptions.md) For text splitting options

## Extends

- `SplitBitmapText`.[`ContainerOptions`](scene.ContainerOptions.md).[`SplitBitmapOptions`](text.SplitBitmapOptions.md)
...
[`SplitBitmapOptions`](text.SplitBitmapOptions.md).[`autoSplit`](text.SplitBitmapOptions.html#autosplit)
...
[`SplitBitmapOptions`](text.SplitBitmapOptions.md).[`charAnchor`](text.SplitBitmapOptions.html#charanchor)
...
[`SplitBitmapOptions`](text.SplitBitmapOptions.md).[`lineAnchor`](text.SplitBitmapOptions.html#lineanchor)
...
[`SplitBitmapOptions`](text.SplitBitmapOptions.md).[`style`](text.SplitBitmapOptions.html#style)
...
[`SplitBitmapOptions`](text.SplitBitmapOptions.md).[`text`](text.SplitBitmapOptions.html#text)
...
[`SplitBitmapOptions`](text.SplitBitmapOptions.md).[`wordAnchor`](text.SplitBitmapOptions.html#wordanchor)
