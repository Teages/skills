...
If you're new to graphics, check out the [graphics guide](scene-6.md) first. This guide covers `fill()` in depth. The `fill()` method lets you fill shapes with colors, textures, or gradients.
