...
[Container](scene.Container.md) is the **base class** for all scene objects in v8 (replacing the old `DisplayObject`).

- Can have children.
- Commonly used to group objects and apply transformations (position, scale, rotation) to the group.
- [ParticleContainer](scene.ParticleContainer.md) is an optimized container for particle systems.
...
- [Sprite](scene.Sprite.md) - Image display
- [AnimatedSprite](scene.AnimatedSprite.md) - Sprite animation
- [TilingSprite](scene.TilingSprite.md) - Repeating texture patterns
- [NineSliceSprite](scene.NineSliceSprite.md) - Scalable UI elements
- [Text](scene.Text.md) - Canvas-based text rendering
- [HTMLText](scene.HTMLText.md) - HTML/CSS-based text
- [BitmapText](scene.BitmapText.md) - High-performance bitmap fonts
- [Graphics](scene.Graphics.md) - Vector shape drawing
- [Mesh](scene.Mesh.md) - Custom vertex-based rendering
  - [MeshSimple](scene.MeshSimple.md) - Basic mesh with convenient constructor
  - [MeshPlane](scene.MeshPlane.md) - Deformable textured plane
  - [MeshRope](scene.MeshRope.md) - Rope-like curved mesh
...
PixiJS supports a variety of color formats. See the [Color documentation](color.md) for details.
...
There are also advanced blend modes like `subtract`, `difference`, and `overlay`. See the full list in the [Blend Modes documentation](filters.md).
...
See the detailed guide on [Interaction](events.md) for setup, hit testing, pointer events, and more.
