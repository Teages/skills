...
## See
 ...
 - [TextStyle](text.TextStyle.md) For detailed style options
 - [BitmapText](scene.BitmapText.md) For better performance with static text
 - [HTMLText](scene.HTMLText.md) For HTML/CSS-based text rendering

## Extends

- `Text`.[`AbstractText`](scene.AbstractText.md)\<[`TextStyle`](text.TextStyle.md), [`TextStyleOptions`](text.TextStyleOptions.md), [`CanvasTextOptions`](scene.CanvasTextOptions.md), `BatchableText`\>.[`AbstractText`](scene.AbstractText.md)\<[`TextStyle`](text.TextStyle.md), [`TextStyleOptions`](text.TextStyleOptions.md), [`CanvasTextOptions`](scene.CanvasTextOptions.md), `BatchableText`\>
...
#### See
 ...
 - [Text#width](#width) For getting just the width
 - [Text#height](#height) For getting just the height
 - [Text#setSize](#setsize) For setting both width and height
...
#### See
 ...
 - [Text#width](#width) For setting width only
 - [Text#height](#height) For setting height only
