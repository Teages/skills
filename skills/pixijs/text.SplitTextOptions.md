...
- Text splitting options from [SplitOptions](text.SplitOptions.md)
- Additional PixiJS-specific options from PixiMixins.SplitText

## See

 - [SplitText](text.SplitText.md) For the main implementation
 - [ContainerOptions](scene.ContainerOptions.md) For base container properties
 - [SplitOptions](text.SplitOptions.md) For text splitting options

## Extends

- `SplitText`.[`ContainerOptions`](scene.ContainerOptions.md).[`SplitOptions`](text.SplitOptions.md)
...
[`SplitOptions`](text.SplitOptions.md).[`autoSplit`](text.SplitOptions.html#autosplit)
...
[`SplitOptions`](text.SplitOptions.md).[`charAnchor`](text.SplitOptions.html#charanchor)
...
[`SplitOptions`](text.SplitOptions.md).[`lineAnchor`](text.SplitOptions.html#lineanchor)
...
[`SplitOptions`](text.SplitOptions.md).[`style`](text.SplitOptions.html#style)
...
[`SplitOptions`](text.SplitOptions.md).[`text`](text.SplitOptions.html#text)
...
[`SplitOptions`](text.SplitOptions.md).[`wordAnchor`](text.SplitOptions.html#wordanchor)
