...
> `readonly` **renderLayerChildren**: [`Container`](scene.Container.md)\<[`ContainerChild`](scene.ContainerChild.md)\>[] = `[]`
...
#### See
 ...
 - [RenderLayer#attach](#attach) For adding objects to the layer
 - [RenderLayer#detach](#detach) For removing objects from the layer
 - [RenderLayer#detachAll](#detachall) For removing all objects from the layer
...
#### See
 ...
 - [RenderLayer#sortRenderLayerChildren](#sortrenderlayerchildren) For manual sorting
 - [RenderLayer#sortFunction](#sortfunction) For customizing the sort logic
...
> `static` **defaultOptions**: [`RenderLayerOptions`](scene.RenderLayerOptions.md)
...
#### See
 ...
 - RenderLayer For the main render layer class
 - [Container#zIndex](scene.DOMContainer.html#zindex) For the default sort property
 - [RenderLayer#sortRenderLayerChildren](#sortrenderlayerchildren) For manual sorting
...
`U` *extends* [`Container`](scene.Container.md)\<[`ContainerChild`](scene.ContainerChild.md)\>[]
...
#### See
 ...
 - [RenderLayer#detach](#detach) For removing objects from the layer
 - [RenderLayer#detachAll](#detachall) For removing all objects from the layer
 - [Container#addChild](scene.Container.html#addchild) For adding to scene graph hierarchy
...
#### See
 ...
 - [RenderLayer#attach](#attach) For adding objects to the layer
 - [RenderLayer#detachAll](#detachall) For removing all objects from the layer
 - [Container#removeChild](scene.Container.html#removechild) For removing from scene graph hierarchy
...
#### See
 ...
 - [RenderLayer#attach](#attach) For adding objects to the layer
 - [RenderLayer#detach](#detach) For removing individual objects
 - [Container#removeChildren](scene.Container.html#removechildren) For removing from scene graph
...
#### See
 ...
 - [RenderLayer#sortableChildren](#sortablechildren) For enabling automatic sorting
 - [RenderLayer#sortFunction](#sortfunction) For customizing the sort logic
