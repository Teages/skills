...
- `NineSliceSprite`.[`ViewContainer`](scene.ViewContainer.md)\<`NineSliceSpriteGpuData`\>
...
> **new NineSliceSprite**(`options`): `NineSliceSprite`
...
##### See
 ...
 - [NineSliceSprite#setSize](#setsize) For setting both width and height efficiently
 - [NineSliceSprite#width](#width) For setting width
...
##### See
 ...
 - [NineSliceSprite#height](#height) For the current displayed height
...
##### See
 ...
 - [NineSliceSprite#width](#width) For the current displayed width
...
##### See
 ...
 - [NineSliceSprite#setSize](#setsize) For setting both width and height efficiently
 - [NineSliceSprite#height](#height) For setting height
...
#### See
 ...
 - [NineSliceSprite#width](#width) For getting just the width
 - [NineSliceSprite#height](#height) For getting just the height
 - [NineSliceSprite#setSize](#setsize) For setting both width and height efficiently
...
#### See
 ...
 - [NineSliceSprite#width](#width) For setting width only
 - [NineSliceSprite#height](#height) For setting height only
