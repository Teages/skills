...
Use `Sprite` when you need to display a single image or spritesheet frame. For repeating textures, see [TilingSprite](scene-5.md). For scalable UI panels, see [NineSliceSprite](scene-4.md).
