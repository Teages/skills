...
## See
 ...
 - [CullerPlugin](app.CullerPlugin.md) For automatic culling in applications
 - [CullingMixinConstructor](scene.CullingMixinConstructor.md) For culling properties
...
[CullerPlugin](app.CullerPlugin.md) For automatic culling using this instance
...
#### See
 ...
 - [CullingMixinConstructor.cullable](scene.CullingMixinConstructor.html#cullable) For enabling culling on objects
 - [CullingMixinConstructor.cullArea](scene.CullingMixinConstructor.html#cullarea) For custom culling boundaries
