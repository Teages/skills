...
- [`TextureSource`](rendering.TextureSource.md)\<[`ICanvas`](environment.ICanvas.md)\>

## Constructors

### Constructor

> **new CanvasSource**(`options`): `CanvasSource`
...
> **resource**: [`ICanvas`](environment.ICanvas.md)
...
> **get** **context2D**(): [`CanvasRenderingContext2D`](https://developer.mozilla.org/docs/Web/API/CanvasRenderingContext2D)
...
> `static` **test**(`resource`): `resource is ICanvas`
