...
The more efficient and simpler way to create an animated sprite is using a [Spritesheet](assets.Spritesheet.md)
...
- `AnimatedSprite`.[`Sprite`](scene.Sprite.md)
...
#### See
 ...
 - [AnimatedSprite#currentFrame](#currentframe) For the current frame index
 - [AnimatedSprite#totalFrames](#totalframes) For total number of frames
...
#### See
 ...
 - [AnimatedSprite#onComplete](#oncomplete) Callback when non-looping animation completes
 - [AnimatedSprite#onLoop](#onloop) Callback when animation loops
...
[`GifSprite`](gif.GifSprite.md).[`anchor`](gif.GifSprite.html#anchor)
...
##### See
 ...
 - [AnimatedSprite#update](#update) For manual animation updates
 - [Ticker](ticker.Ticker.md) For the timing system
...
##### See
 ...
 - [AnimatedSprite#totalFrames](#totalframes) For the total number of frames
 - [AnimatedSprite#gotoAndPlay](#gotoandplay) For playing from a specific frame
 - [AnimatedSprite#gotoAndStop](#gotoandstop) For stopping at a specific frame
...
[`GifSprite`](gif.GifSprite.md).[`height`](gif.GifSprite.html#height)
...
##### See
 ...
 - [AnimatedSprite#play](#play) For starting playback
 - [AnimatedSprite#stop](#stop) For stopping playback
 - [AnimatedSprite#loop](#loop) For controlling looping behavior
...
[`GifSprite`](gif.GifSprite.md).[`texture`](gif.GifSprite.html#texture)
...
> **get** **textures**(): [`AnimatedSpriteFrames`](scene.AnimatedSpriteFrames.md)
...
##### See
 ...
 - [FrameObject](scene.FrameObject.md) For frame timing options
 - [Spritesheet](assets.Spritesheet.md) For loading from spritesheets
...
##### See
 ...
 - [AnimatedSprite#currentFrame](#currentframe) For the current frame index
 - [AnimatedSprite#textures](#textures) For the array of textures
...
[`GifSprite`](gif.GifSprite.md).[`visualBounds`](gif.GifSprite.html#visualbounds)
...
[`GifSprite`](gif.GifSprite.md).[`width`](gif.GifSprite.html#width)
...
#### See
 ...
 - [AnimatedSprite#gotoAndStop](#gotoandstop) For going to a frame without playing
 - [AnimatedSprite#play](#play) For playing from current frame
 - [AnimatedSprite#currentFrame](#currentframe) For getting/setting current frame
...
#### See
 ...
 - [AnimatedSprite#gotoAndPlay](#gotoandplay) For going to a frame and playing
 - [AnimatedSprite#currentFrame](#currentframe) For getting/setting current frame
 - [AnimatedSprite#totalFrames](#totalframes) For total number of frames
...
#### See
 ...
 - [AnimatedSprite#stop](#stop) For stopping playback
 - [AnimatedSprite#gotoAndPlay](#gotoandplay) For playing from a specific frame
 - [AnimatedSprite#playing](#playing) For checking play state
...
#### See
 ...
 - [AnimatedSprite#autoUpdate](#autoupdate) For controlling automatic updates
 - [AnimatedSprite#animationSpeed](#animationspeed) For controlling animation speed
...
#### See
 ...
 - [Texture.from](rendering.RenderTexture.html#from) For texture creation from frames
 - [Spritesheet](assets.Spritesheet.md) For loading spritesheets
...
#### See
 ...
 - [Assets](assets.Assets.md) For asset loading and management
 - [Texture.from](rendering.RenderTexture.html#from) For texture creation from images
