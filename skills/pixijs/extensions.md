...
- See [ExtensionType](extensions.ExtensionType.md) for all extension types
- See [ExtensionFormatLoose](extensions.ExtensionFormatLoose.md) for extension metadata format
- See [extensions](extensions.extensions.md) for the extension registry
- See [Application](app.Application.md) for application plugins
- See [Assets](assets.Assets.md) for the asset loading system
- See [Renderer](rendering.Renderer.md) for rendering extensions
- See [LoaderParser](assets.LoaderParser.md) for asset loader interface
- See [ResolveURLParser](assets.ResolveURLParser.md) for URL resolution interface
- See [CacheParser](assets.CacheParser.md) for cache parser interface
