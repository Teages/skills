...
Thanks to [gifuct-js](https://github.com/matt-way/gifuct-js/)
...
> **new GifSprite**(`source`): `GifSprite`
...
Source, default options will be used.
...
[`Sprite`](scene.Sprite.md).[`constructor`](scene.Sprite.html#constructor)

### Constructor

> **new GifSprite**(`options`): `GifSprite`
...
[`Sprite`](scene.Sprite.md).[`autoGarbageCollect`](scene.Sprite.html#autogarbagecollect)
...
If `false`, you must call [GifSprite.play](#play) to start playback.
...
[`Sprite`](scene.Sprite.md).[`boundsArea`](scene.Sprite.html#boundsarea)
...
[`Sprite`](scene.Sprite.md).[`cacheAsBitmap`](scene.Sprite.html#cacheasbitmap)
...
[`Sprite`](scene.Sprite.md).[`cacheAsTexture`](scene.Sprite.html#cacheastexture)
...
[`Sprite`](scene.Sprite.md).[`children`](scene.Sprite.html#children)
...
[`Sprite`](scene.Sprite.md).[`cursor`](scene.Sprite.html#cursor)
...
[`Sprite`](scene.Sprite.md).[`destroyed`](scene.Sprite.html#destroyed)
...
#### See
 ...
 - [GifSprite.progress](#progress) For animation progress
 - [GifSprite.currentFrame](#currentframe) For current frame number
...
[`Sprite`](scene.Sprite.md).[`effects`](scene.Sprite.html#effects)
...
[`Sprite`](scene.Sprite.md).[`eventMode`](scene.Sprite.html#eventmode)
...
[`Sprite`](scene.Sprite.md).[`filterArea`](scene.Sprite.html#filterarea)
...
[`Sprite`](scene.Sprite.md).[`groupTransform`](scene.Sprite.html#grouptransform)
...
[`Sprite`](scene.Sprite.md).[`hitArea`](scene.Sprite.html#hitarea)
...
[`Sprite`](scene.Sprite.md).[`interactive`](scene.Sprite.html#interactive)
...
[`Sprite`](scene.Sprite.md).[`interactiveChildren`](scene.Sprite.html#interactivechildren)
...
[`Sprite`](scene.Sprite.md).[`isCachedAsTexture`](scene.Sprite.html#iscachedastexture)
...
[`Sprite`](scene.Sprite.md).[`isInteractive`](scene.Sprite.html#isinteractive)
...
#### See
 ...
 - [Container#worldTransform](#worldtransform) For global transform
 - [Container#groupTransform](scene.ViewContainer.html#grouptransform) For render group transform

#### Inherited from

[`Sprite`](scene.Sprite.md).[`localTransform`](scene.Sprite.html#localtransform)
...
[`Sprite`](scene.Sprite.md).[`mask`](scene.Sprite.html#mask)
...
[`Sprite`](scene.Sprite.md).[`name`](scene.Sprite.html#name)
...
[`Sprite`](scene.Sprite.md).[`onclick`](scene.Sprite.html#onclick)
...
If `loop` is `true`, use [GifSprite.onLoop](#onloop) instead.
...
#### See
 ...
 - [GifSprite.currentFrame](#currentframe)
 - [GifSprite.play](#play)
 - [GifSprite.stop](#stop)
...
[`Sprite`](scene.Sprite.md).[`onglobalmousemove`](scene.Sprite.html#onglobalmousemove)
...
[`Sprite`](scene.Sprite.md).[`onglobalpointermove`](scene.Sprite.html#onglobalpointermove)
...
[`Sprite`](scene.Sprite.md).[`onglobaltouchmove`](scene.Sprite.html#onglobaltouchmove)
...
[`Sprite`](scene.Sprite.md).[`onmousedown`](scene.Sprite.html#onmousedown)
...
[`Sprite`](scene.Sprite.md).[`onmouseenter`](scene.Sprite.html#onmouseenter)
...
[`Sprite`](scene.Sprite.md).[`onmouseleave`](scene.Sprite.html#onmouseleave)
...
[`Sprite`](scene.Sprite.md).[`onmousemove`](scene.Sprite.html#onmousemove)
...
[`Sprite`](scene.Sprite.md).[`onmouseout`](scene.Sprite.html#onmouseout)
...
[`Sprite`](scene.Sprite.md).[`onmouseover`](scene.Sprite.html#onmouseover)
...
[`Sprite`](scene.Sprite.md).[`onmouseup`](scene.Sprite.html#onmouseup)
...
[`Sprite`](scene.Sprite.md).[`onmouseupoutside`](scene.Sprite.html#onmouseupoutside)
...
[`Sprite`](scene.Sprite.md).[`onpointercancel`](scene.Sprite.html#onpointercancel)
...
[`Sprite`](scene.Sprite.md).[`onpointerdown`](scene.Sprite.html#onpointerdown)
...
[`Sprite`](scene.Sprite.md).[`onpointerenter`](scene.Sprite.html#onpointerenter)
...
[`Sprite`](scene.Sprite.md).[`onpointerleave`](scene.Sprite.html#onpointerleave)
...
[`Sprite`](scene.Sprite.md).[`onpointermove`](scene.Sprite.html#onpointermove)
...
[`Sprite`](scene.Sprite.md).[`onpointerout`](scene.Sprite.html#onpointerout)
...
[`Sprite`](scene.Sprite.md).[`onpointerover`](scene.Sprite.html#onpointerover)
...
[`Sprite`](scene.Sprite.md).[`onpointertap`](scene.Sprite.html#onpointertap)
...
[`Sprite`](scene.Sprite.md).[`onpointerup`](scene.Sprite.html#onpointerup)
...
[`Sprite`](scene.Sprite.md).[`onpointerupoutside`](scene.Sprite.html#onpointerupoutside)
...
[`Sprite`](scene.Sprite.md).[`onrightclick`](scene.Sprite.html#onrightclick)
...
[`Sprite`](scene.Sprite.md).[`onrightdown`](scene.Sprite.html#onrightdown)
...
[`Sprite`](scene.Sprite.md).[`onrightup`](scene.Sprite.html#onrightup)
...
[`Sprite`](scene.Sprite.md).[`onrightupoutside`](scene.Sprite.html#onrightupoutside)
...
[`Sprite`](scene.Sprite.md).[`ontap`](scene.Sprite.html#ontap)
...
[`Sprite`](scene.Sprite.md).[`ontouchcancel`](scene.Sprite.html#ontouchcancel)
...
[`Sprite`](scene.Sprite.md).[`ontouchend`](scene.Sprite.html#ontouchend)
...
[`Sprite`](scene.Sprite.md).[`ontouchendoutside`](scene.Sprite.html#ontouchendoutside)
...
[`Sprite`](scene.Sprite.md).[`ontouchmove`](scene.Sprite.html#ontouchmove)
...
[`Sprite`](scene.Sprite.md).[`ontouchstart`](scene.Sprite.html#ontouchstart)
...
[`Sprite`](scene.Sprite.md).[`onwheel`](scene.Sprite.html#onwheel)
...
[`Sprite`](scene.Sprite.md).[`parent`](scene.Sprite.html#parent)
...
[`Sprite`](scene.Sprite.md).[`parentRenderLayer`](scene.Sprite.html#parentrenderlayer)
...
[`Sprite`](scene.Sprite.md).[`relativeGroupTransform`](scene.Sprite.html#relativegrouptransform)
...
[`Sprite`](scene.Sprite.md).[`sortChildren`](scene.Sprite.html#sortchildren)
...
[`Sprite`](scene.Sprite.md).[`updateCacheTexture`](scene.Sprite.html#updatecachetexture)
...
> `static` **defaultOptions**: [`Omit`](https://www.typescriptlang.org/docs/handbook/utility-types.html#omittype-keys)\<[`GifSpriteOptions`](gif.GifSpriteOptions.md), `"source"`\>
...
##### See
 ...
 - [Container#visible](#visible) For toggling visibility
 - [Container#renderable](#renderable) For render control
...
[`Sprite`](scene.Sprite.md).[`alpha`](scene.Sprite.html#alpha)
...
[`Sprite`](scene.Sprite.md).[`anchor`](scene.Sprite.html#anchor)
...
[`Sprite`](scene.Sprite.md).[`angle`](scene.Sprite.html#angle)
...
Whether to use [Ticker.shared](ticker.Ticker.html#shared) to auto update animation time.
...
##### See
 ...
 - [GifSprite.update](#update) For manual updating
 - [Ticker.shared](ticker.Ticker.html#shared) For the shared ticker instance
...
##### See
 ...
 - [Container#alpha](#alpha) For transparency
 - [Container#tint](#tint) For color adjustments
...
[`Sprite`](scene.Sprite.md).[`blendMode`](scene.Sprite.html#blendmode)
...
[`Sprite`](scene.Sprite.md).[`bounds`](scene.Sprite.html#bounds)
...
##### See
 ...
 - [GifSprite.totalFrames](#totalframes) For frame count
 - [GifSprite.onFrameChange](#onframechange) For frame change events
...
[`Sprite`](scene.Sprite.md).[`filters`](scene.Sprite.html#filters)
...
[`Sprite`](scene.Sprite.md).[`height`](scene.Sprite.html#height)
...
[`Sprite`](scene.Sprite.md).[`isRenderable`](scene.Sprite.html#isrenderable)
...
[`Sprite`](scene.Sprite.md).[`isRenderGroup`](scene.Sprite.html#isrendergroup)
...
[`Sprite`](scene.Sprite.md).[`origin`](scene.Sprite.html#origin)
...
[`Sprite`](scene.Sprite.md).[`pivot`](scene.Sprite.html#pivot)
...
[`Sprite`](scene.Sprite.md).[`position`](scene.Sprite.html#position)
...
[GifSprite.duration](#duration) For total animation length
...
##### See
 ...
 - [Container#visible](#visible) For skipping transform updates
 - [Container#alpha](#alpha) For transparency
...
[`Sprite`](scene.Sprite.md).[`renderable`](scene.Sprite.html#renderable)
...
[`Sprite`](scene.Sprite.md).[`rotation`](scene.Sprite.html#rotation)
...
[`Sprite`](scene.Sprite.md).[`roundPixels`](scene.Sprite.html#roundpixels)
...
[`Sprite`](scene.Sprite.md).[`scale`](scene.Sprite.html#scale)
...
[`Sprite`](scene.Sprite.md).[`skew`](scene.Sprite.html#skew)
...
> **get** **source**(): [`GifSource`](gif.GifSource.md)
...
##### See
 ...
 - [GifSource](gif.GifSource.md) For source data implementation
 - [GifSprite.clone](#clone) For creating independent instances
...
[`Sprite`](scene.Sprite.md).[`texture`](scene.Sprite.html#texture)
...
##### See
 ...
 - [Container#alpha](#alpha) For transparency
 - [Container#visible](#visible) For visibility control
...
[`Sprite`](scene.Sprite.md).[`tint`](scene.Sprite.html#tint)
...
##### See
 ...
 - [GifSprite.currentFrame](#currentframe) For current frame index
 - [GifSource.totalFrames](gif.GifSource.html#totalframes) For source frame count
...
##### See
 ...
 - [Container#renderable](#renderable) For render-only control
 - [Container#alpha](#alpha) For transparency
...
[`Sprite`](scene.Sprite.md).[`visible`](scene.Sprite.html#visible)
...
> **get** **visualBounds**(): [`BoundsData`](rendering.BoundsData.md)
...
[`Sprite`](scene.Sprite.md).[`visualBounds`](scene.Sprite.html#visualbounds)
...
[`Sprite`](scene.Sprite.md).[`width`](scene.Sprite.html#width)
...
[`Sprite`](scene.Sprite.md).[`worldTransform`](scene.Sprite.html#worldtransform)
...
[`Sprite`](scene.Sprite.md).[`x`](scene.Sprite.html#x)
...
[`Sprite`](scene.Sprite.md).[`y`](scene.Sprite.html#y)
...
[`Sprite`](scene.Sprite.md).[`_onTouch`](scene.Sprite.html#_ontouch)
...
[`Sprite`](scene.Sprite.md).[`addChild`](scene.Sprite.html#addchild)
...
[`Sprite`](scene.Sprite.md).[`addChildAt`](scene.Sprite.html#addchildat)
...
[`Sprite`](scene.Sprite.md).[`addEventListener`](scene.Sprite.html#addeventlistener)
...
A new GifSprite instance with the same properties
...
#### See
 ...
 - [GifSprite.source](#source) For shared source data
 - [GifSprite.destroy](#destroy) For cleanup
...
[`Sprite`](scene.Sprite.md).[`containsPoint`](scene.Sprite.html#containspoint)

***

### destroy()

> **destroy**(`destroyData`): `void`
...
Destroy the data, cannot be used again.
...
[`Sprite`](scene.Sprite.md).[`destroy`](scene.Sprite.html#destroy)
...
[`Sprite`](scene.Sprite.md).[`disableRenderGroup`](scene.Sprite.html#disablerendergroup)
...
[`Sprite`](scene.Sprite.md).[`dispatchEvent`](scene.Sprite.html#dispatchevent)
...
[`Sprite`](scene.Sprite.md).[`enableRenderGroup`](scene.Sprite.html#enablerendergroup)
...
[`Sprite`](scene.Sprite.md).[`getBounds`](scene.Sprite.html#getbounds)
...
[`Sprite`](scene.Sprite.md).[`getChildAt`](scene.Sprite.html#getchildat)
...
[`Sprite`](scene.Sprite.md).[`getChildByLabel`](scene.Sprite.html#getchildbylabel)
...
[`Sprite`](scene.Sprite.md).[`getChildByName`](scene.Sprite.html#getchildbyname)
...
[`Sprite`](scene.Sprite.md).[`getChildIndex`](scene.Sprite.html#getchildindex)
...
[`Sprite`](scene.Sprite.md).[`getChildrenByLabel`](scene.Sprite.html#getchildrenbylabel)
...
[`Sprite`](scene.Sprite.md).[`getFastGlobalBounds`](scene.Sprite.html#getfastglobalbounds)
...
[`Sprite`](scene.Sprite.md).[`getGlobalAlpha`](scene.Sprite.html#getglobalalpha)
...
[`Sprite`](scene.Sprite.md).[`getGlobalPosition`](scene.Sprite.html#getglobalposition)
...
[`Sprite`](scene.Sprite.md).[`getGlobalTint`](scene.Sprite.html#getglobaltint)
...
[`Sprite`](scene.Sprite.md).[`getGlobalTransform`](scene.Sprite.html#getglobaltransform)
...
[`Sprite`](scene.Sprite.md).[`getLocalBounds`](scene.Sprite.html#getlocalbounds)
...
Retrieves the size of the Sprite as a [Size][Size](maths.Size.md) object based on the texture dimensions and scale.
...
#### See
 ...
 - [Sprite#width](scene.Sprite.html#width) For getting just the width
 - [Sprite#height](scene.Sprite.html#height) For getting just the height
 - [Sprite#setSize](scene.Sprite.html#setsize) For setting both width and height

#### Inherited from

[`Sprite`](scene.Sprite.md).[`getSize`](scene.Sprite.html#getsize)
...
#### See
 ...
 - [GifSprite.stop](#stop) For stopping playback
 - [GifSprite.playing](#playing) For checking playback status
 - [GifSprite.autoUpdate](#autoupdate) For controlling automatic updates
...
[`Sprite`](scene.Sprite.md).[`removeChild`](scene.Sprite.html#removechild)
...
[`Sprite`](scene.Sprite.md).[`removeChildAt`](scene.Sprite.html#removechildat)
...
[`Sprite`](scene.Sprite.md).[`removeChildren`](scene.Sprite.html#removechildren)
...
[`Sprite`](scene.Sprite.md).[`removeEventListener`](scene.Sprite.html#removeeventlistener)
...
[`Sprite`](scene.Sprite.md).[`removeFromParent`](scene.Sprite.html#removefromparent)
...
[`Sprite`](scene.Sprite.md).[`reparentChild`](scene.Sprite.html#reparentchild)
...
[`Sprite`](scene.Sprite.md).[`reparentChildAt`](scene.Sprite.html#reparentchildat)
...
[`Sprite`](scene.Sprite.md).[`replaceChild`](scene.Sprite.html#replacechild)
...
[`Sprite`](scene.Sprite.md).[`setChildIndex`](scene.Sprite.html#setchildindex)
...
[`Sprite`](scene.Sprite.md).[`setFromMatrix`](scene.Sprite.html#setfrommatrix)
...
[`Sprite`](scene.Sprite.md).[`setMask`](scene.Sprite.html#setmask)
...
#### See
 ...
 - [Sprite#width](scene.Sprite.html#width) For setting width only
 - [Sprite#height](scene.Sprite.html#height) For setting height only
 - [Sprite#texture](scene.Sprite.html#texture) For the source dimensions

#### Inherited from

[`Sprite`](scene.Sprite.md).[`setSize`](scene.Sprite.html#setsize)
...
#### See
 ...
 - [GifSprite.play](#play) For resuming playback
 - [GifSprite.currentFrame](#currentframe) For frame control
...
[`Sprite`](scene.Sprite.md).[`swapChildren`](scene.Sprite.html#swapchildren)
...
[`Sprite`](scene.Sprite.md).[`toGlobal`](scene.Sprite.html#toglobal)
...
[`Sprite`](scene.Sprite.md).[`toLocal`](scene.Sprite.html#tolocal)
...
[`Sprite`](scene.Sprite.md).[`unload`](scene.Sprite.html#unload)
...
Ticker instance used to calculate frame timing
...
#### See
 ...
 - [GifSprite.autoUpdate](#autoupdate) For automatic update control
 - [GifSprite.playing](#playing) For playback state
 - [Ticker](ticker.Ticker.md) For timing system details
...
[`Sprite`](scene.Sprite.md).[`updateLocalTransform`](scene.Sprite.html#updatelocaltransform)
...
#### See
 ...
 - [Container#position](#position) For direct position access

#### Inherited from

[`Sprite`](scene.Sprite.md).[`updateTransform`](scene.Sprite.html#updatetransform)

***

### from()

> `static` **from**(`source`, `skipCache`): [`Sprite`](scene.Sprite.md)
...
The source to create the sprite from. Can be a path to an image, a texture,
or any valid texture source (canvas, video, etc.)

[`Texture`](rendering.Texture.md)\<[`TextureSource`](rendering.TextureSource.md)\<`any`\>\> | [`TextureSourceLike`](rendering.TextureSourceLike.md)
...
[`Sprite`](scene.Sprite.md).[`from`](scene.Sprite.html#from)
...
[`Sprite`](scene.Sprite.md).[`mixin`](scene.Sprite.html#mixin)
