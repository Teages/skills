...
## See
 ...
 - [SpriteOptions](scene.SpriteOptions.md) For configuration options
 - [Texture](rendering.Texture.md) For texture management
 - [Assets](assets.Assets.md) For asset loading

## Extends

- `Sprite`.[`ViewContainer`](scene.ViewContainer.md)\<`BatchableSprite`\>
...
[`Texture`](rendering.Texture.md)\<[`TextureSource`](rendering.TextureSource.md)\<`any`\>\> | [`SpriteOptions`](scene.SpriteOptions.md)
...
> [!IMPORTANT] In PixiJS a regular mask must be a [Graphics](scene.Graphics.md) or a Sprite object.
...
#### See
 ...
 - [Sprite#width](#width) For getting just the width
 - [Sprite#height](#height) For getting just the height
 - [Sprite#setSize](#setsize) For setting both width and height
...
#### See
 ...
 - [Sprite#width](#width) For setting width only
 - [Sprite#height](#height) For setting height only
 - [Sprite#texture](#texture) For the source dimensions
