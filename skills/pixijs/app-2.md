...
The [ResizePlugin](app.ResizePlugin.md) auto-resizes PixiJS applications. It listens to window or element resize events and adjusts the renderer to match.
...
PixiJS includes this plugin by default when initializing an [Application](app.Application.md). You can also register it manually for custom setups.
