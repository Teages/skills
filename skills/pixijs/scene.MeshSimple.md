...
## See
 ...
 - [Mesh](scene.Mesh.md) For more advanced mesh customization
 - [MeshGeometry](scene.MeshGeometry.md) For direct geometry manipulation
...
> **new MeshSimple**(`options`): `MeshSimple`
...
#### See
 ...
 - [MeshGeometry#getBuffer](rendering.Geometry.html#getbuffer) For manual buffer updates
 - [MeshSimple#vertices](#vertices) For accessing vertex data
...
> **get** **vertices**(): [`TypedArray`](rendering.TypedArray.md)
...
##### See
 ...
 - [MeshSimple#autoUpdate](#autoupdate) For controlling vertex buffer updates
 - [MeshGeometry#getBuffer](rendering.Geometry.html#getbuffer) For direct buffer access
