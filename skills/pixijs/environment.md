...
You can create custom adapters for non-standard environments like Node.js or headless testing frameworks. The adapter must satisfy the full [Adapter](environment.Adapter.md) interface:
...
- [Adapter](environment.Adapter.md) - The interface all adapters must satisfy
- [BrowserAdapter](environment.BrowserAdapter.md) - Default browser adapter
- [WebWorkerAdapter](environment.WebWorkerAdapter.md) - Web Worker adapter using `OffscreenCanvas`
- [DOMAdapter](environment.DOMAdapter.md) - Getter/setter for the active adapter
- [ICanvas](environment.ICanvas.md) - Canvas abstraction used across environments
